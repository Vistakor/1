...
def save_image_from_message(message):
    ...
    image_url = "https://api.telegram.org/file/bot{0}/{1}".format('5532689573:AAH4xa87G9ak2nJalDinLTfdOeWtnFuba70',
                                                                  file_path)
    print(image_url)
...
def classify_image(image_name):
    ...
    os.system(
        'cd darknet && darknet classifier predict cfg/imagenet1k.data cfg/darknet19.cfg darknet19.weights ../../{0}/{1} > ../../{0}/results.txt'.format(
...
def object_recognition_image(image_name):
    ...
    os.system('cd darknet && darknet detect cfg/yolov3.cfg yolov3.weights ../../{0}/{1}'.format(
        result_storage_path, image_name))
